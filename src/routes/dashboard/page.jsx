...
const DashboardPage = () => {
    ...
    return (
        <div className="flex flex-col gap-y-4">
            <h1 className="title text-green-500">WHatsapp Business Platform Guide in KIT19</h1>
                ...
                >
                    <div className="card">
                        <div className="card-header">
                            ...
                            <p className="card-title">Broadcast</p>
                        </div>
                        <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
                            <p className="text-3xl font-bold text-slate-900 transition-colors dark:text-slate-50">Whatsapp Marketing</p>
                ...
                <div className="card">
                    <div className="card-header">
                        <div className="rounded-lg bg-green-500/20 p-2 text-green-500 transition-colors dark:bg-green-600/20 dark:text-green-600">
                            ...
                            <p className="card-title">Template Guide</p>
                     
                    </div>
                    <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
                        <p className="text-2xl font-bold text-slate-900 transition-colors dark:text-slate-50">Response Capture, Call To Action Etc..</p>
